...
class Text(Enum):
    ...
    TEXTBOX_POSITION = (Display.FOREGROUND_POSITION.value[0], 20)
    TEXTBOX_SIZE = (Display.FOREGROUND_SIZE.value[0],
                    Display.FOREGROUND_POSITION.value[1] -
                    TEXTBOX_POSITION[1])
    TEXTBOX_OUTLINE_COLOR = (90, 90, 90)
    TEXTBOX_OUTLINE_WIDTH = 2
    TEXTBOX_OUTLINE_RADIUS = 5
    TEXTBOX_RELATIVE_TEXT_POSITION = (3, 3)
